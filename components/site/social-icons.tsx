 ...
 * Marka ikonları.
 *
 * lucide-react 1.x sürümünde marka (Instagram, LinkedIn…) ikonları kaldırıldığı
 * için bu ikonlar burada satır içi SVG olarak tutulur.
 */
...
export function TiktokIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 3.79-4.25V9.66a6.33 6.33 0 0 0-5.42 10.7 6.34 6.34 0 0 0 10.87-4.42V8.99a8.16 8.16 0 0 0 4.77 1.52V7.07a4.85 4.85 0 0 1-1.59-.38Z" />
    </svg>
  );
}
